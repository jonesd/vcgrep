...
CardProgress.prototype._onEnd = function _onEnd(matches) {
  ...
  this._printString(12, this.pageHeight -2, 'Done. '+matches.totalFiles+' files. '+matches.total+' matches. '+ _.keys(matches.keys).length+' unique. '+(Math.floor(duration / 100)/10)+'s.', this.pageWidth-11);
